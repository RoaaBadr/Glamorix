      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <input
            ...
            className={`px-4 py-3 w-full sm:w-96 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
              theme === 'night'
          ...
          <button
            type="submit"
            className={`px-6 py-3 cursor-pointer font-medium rounded-lg transition-colors disabled:opacity-50 ${
              theme === 'night'

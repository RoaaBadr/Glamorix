    ...
    <footer className="footer p-10 bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm">
            Your trusted beauty destination since 2015
            <br />
            Cruelty-free • Vegan options • Sustainable packaging
          </p>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-pink-400 transition-colors">Haircare</a></li>
            <li><a href="#" className="hover:text-pink-400 transition-colors">Fragrance</a></li>
            <li><a href="#" className="hover:text-pink-400 transition-colors">Men's Care</a></li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-pink-400 transition-colors">Sustainability</a></li>
